...
static int realize_canvas(raster_t *raster)
{
    ...
    fprintf(stderr, "[VICE DEBUG] realize_canvas: video_disabled_mode=%d\n", video_disabled_mode);

    if (!video_disabled_mode) {
        fprintf(stderr, "[VICE DEBUG] realize_canvas: calling video_canvas_create\n");
...
int raster_realize(raster_t *raster)
{
    ...
    fprintf(stderr, "[VICE DEBUG] raster_realize: called, raster=%p\n", (void*)raster);
