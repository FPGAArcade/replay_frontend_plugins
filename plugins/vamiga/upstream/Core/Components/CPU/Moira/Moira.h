...
public:
    ...
    // HLE ROM callback - if set, called when PC is in ROM space
    // Returns true if the native handler handled the instruction
    bool (*hleCallback)(void* ctx, u32 pc) = nullptr;
    void* hleContext = nullptr;
