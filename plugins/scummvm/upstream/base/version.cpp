...
#endif
// The build timestamp is deliberately gone: a published plugin must rebuild byte-identically,
// and __DATE__/__TIME__ make that impossible. The version and revision still identify the build.
